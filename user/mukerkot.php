...
<head>
    ...
    <title>Musyawarah Kerja Kota PMI Depok - PMI DEPOK</title>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="card text-center"><img class="card-img-top w-100 d-block" src="../edit-artikel/gambar/<?= $pengurus["gambar"];?>">
                                        ...
                                        <div><a href="pengururs-pmi.php"><button class="btn btn-outline-primary" type="button">Baca Selengkapnya</button></a></div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-4">

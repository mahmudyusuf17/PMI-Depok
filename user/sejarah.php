<?php
include '../config.php';
$contoh = mysqli_query($koneksi, "SELECT * FROM artikel WHERE id=1");
            ...
            <div class="container">
                <div class="block-content">
                    ...
                    <div class="post-image" style="background-image:url(&quot;../edit-artikel/gambar/<?php echo $post["gambar"];?>&quot;);"></div><br>
                        ...
                        <figure class="figure"><img class="rounded img-fluid figure-img" src="../edit-artikel/gambar/<?= $post["gambar"];?>" alt="Kegiatan donor darah">
                            <figcaption class="figure-caption">Logo Palang Merah Indonesia</figcaption>
                            </figure>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-4">
                                    <div class="card text-center"><img class="card-img-top w-100 d-block" src="../edit-artikel/gambar/<?= $gedung["gambar"];?>">
                                        <div class="card-body">
                                            <h5 class="card-title"><?= $gedung["judul"];?></h5>
                                        </div>
                                        <div><a href="gedung.php"><button class="btn btn-outline-primary" type="button">Baca Selengkapnya</button></a></div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-4">
                                    <div class="card text-center"><img class="card-img-top w-100 d-block" src="../edit-artikel/gambar/<?= $pengurus["gambar"];?>">
                                        <div class="card-body">
                                            <h5 class="card-title"><?= $pengurus["judul"];?></h5>
                                        </div>
                                        <div><a href="pengurus-pmi.php"><button class="btn btn-outline-primary" type="button">Baca Selengkapnya</button></a></div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-4">
                                    <div class="card text-center"><img class="card-img-top w-100 d-block" src="../edit-artikel/gambar/<?= $fungsi["gambar"];?>">
                                        ...
                                        <div><a href="tugas-dan-fungsi.php"><button class="btn btn-outline-primary" type="button">Baca Selengkapnya</button></a></div>
                                    </div>
                                </div>
                            </div>
                        </div>

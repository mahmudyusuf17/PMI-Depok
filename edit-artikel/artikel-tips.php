...
<?php
include '../config.php';
$contoh = mysqli_query($koneksi, "SELECT * FROM artikel WHERE id=7");
...
<head>
    ...
    <title>Tips Donor Darah - PMI DEPOK</title>
                    ...
                    <div><input type="hidden" name="id" value="<?php echo $post ["id"]; ?>"></div>
                        ...
                        <div class="block-heading">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="card text-center"><img class="card-img-top w-100 d-block" src="../edit-artikel/gambar/<?= $sejarah["gambar"];?>">
                                        <div class="card-body">
                                            <h5 class="card-title"><?= $sejarah["judul"];?></h5>
                                        </div>
                                        <div><a href="artikel-sejarah.php"><button class="btn btn-outline-primary" type="button">Baca Selengkapnya</button></a></div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-4">

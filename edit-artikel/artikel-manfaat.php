...
<?php
include '../config.php';
$contoh = mysqli_query($koneksi, "SELECT * FROM artikel WHERE id=6");
...
<head>
    ...
    <title>Manfaat Donor Darah - PMI DEPOK</title>
                        ...
                        <div class="block-heading">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-4">
                                    <div class="card text-center"><img class="card-img-top w-100 d-block" src="../edit-artikel/gambar/<?= $jenis["gambar"];?>">
                                        <div class="card-body">
                                            <h5 class="card-title"><?= $jenis["judul"];?></h5>
                                        </div>
                                        <div><a href="artikel-jenisdarah.php"><button class="btn btn-outline-primary" type="button">Baca Selengkapnya</button></a></div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-4">

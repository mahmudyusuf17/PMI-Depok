...
<head>
    ...
    <title>Tujuan dan Fungsi PMI Depok - PMI DEPOK</title>
    ...
    <main class="page blog-post">
        ...
        <div class="container">
                <div class="block-content">
                    ...
                    <div class="post-image" style="background-image:url(&quot;gambar/<?php echo $post["gambar"];?>&quot;);" id="tujuan"></div>
                    <br>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-4">
                                    <div class="card text-center"><img class="card-img-top w-100 d-block" src="../edit-artikel/gambar/<?= $visimisi["gambar"];?>">
                                        ...
                                        <div><a href="artikel-visimisi.php"><button class="btn btn-outline-primary" type="button">Baca Selengkapnya</button></a></div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-4">

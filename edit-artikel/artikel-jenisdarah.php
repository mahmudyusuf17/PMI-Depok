...
<?php
include '../config.php';
$contoh = mysqli_query($koneksi, "SELECT * FROM artikel WHERE id=8");
...
<head>
    ...
    <title>Jenis Komponen Darah - PMI DEPOK</title>
        ...
        <section class="clean-block clean-post dark" style="background-image:url(&quot;../assets/img/wallpaper/bg-motif.jpg&quot;)">
            <div class="container">
                <div class="block-content">
                    ...
                    <div class="post-image" style="background-image:url(&quot;gambar/<?php echo $post["gambar"];?>&quot;);"></div>
                    <br>
                    <a href="hapus.php?id=<?= $post["id"]; ?>" class="btn btn-danger btn-lg float-right" type="submit" class="btn btn-danger" name="hapus" onclick="return confirm('Anda yakin akan menghapus data?');">
                    ...
                    <div><input type="hidden" name="id" value="<?php echo $post ["id"]; ?>"></div>
                        ...
                        <div class="block-heading">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-4">
                                    <div class="card text-center"><img class="card-img-top w-100 d-block" src="../edit-artikel/gambar/<?= $tips["gambar"];?>">
                                        <div class="card-body">
                                            <h5 class="card-title"><?= $tips["judul"];?></h5>
                                        </div>
                                        <div><a href="artikel-tips.php"><button class="btn btn-outline-primary" type="button">Baca Selengkapnya</button></a></div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-4">
                                    <div class="card text-center"><img class="card-img-top w-100 d-block" src="../edit-artikel/gambar/<?= $karakteristik["gambar"];?>">
                                        <div class="card-body">
                                            <h5 class="card-title"><?= $karakteristik["judul"];?></h5>
                                        </div>
                                        <div><a href="artikel-karakteristik.php"><button class="btn btn-outline-primary" type="button">Baca Selengkapnya</button></a></div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-4">
                                    <div class="card text-center"><img class="card-img-top w-100 d-block" src="../edit-artikel/gambar/<?= $manfaat["gambar"];?>">
                                        <div class="card-body">
                                            <h5 class="card-title"><?= $manfaat["judul"];?></h5>
                                        </div>
                                        <div><a href="artikel-manfaat.php"><button class="btn btn-outline-primary" type="button">Baca Selengkapnya</button></a></div>
                                    </div>
                                </div>
                            </div>
                        </div>

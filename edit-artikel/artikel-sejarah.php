        ...
        <section class="clean-block clean-post dark" style="background-image:url(&quot;../assets/img/wallpaper/bg-motif.jpg&quot;)">
            <div class="container">
                <div class="block-content">
                    ...
                    <div><input type="hidden" name="id" value="<?= $post ["id"]; ?>"></div>
                        <h3><?php echo $post["judul"];?></h3>
                        <div class="post-info"><span>By <?= $post["nama_penulis"];?></span><span><?= $post["tgl"];?></span></div>
                        <p><?= $post["isi"];?></p>
                        <figure class="figure"><img class="rounded img-fluid figure-img" src="gambar/<?= $post["gambar"];?>" alt="Kegiatan donor darah">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-4">
                                    <div class="card text-center"><img class="card-img-top w-100 d-block" src="../edit-artikel/gambar/<?= $gedung["gambar"];?>">
                                        ...
                                        <div><a href="artikel-peresmian.php"><button class="btn btn-outline-primary" type="button">Baca Selengkapnya</button></a></div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-4">
                                    <div class="card text-center"><img class="card-img-top w-100 d-block" src="../edit-artikel/gambar/<?= $pengurus["gambar"];?>">
                                        ...
                                        <div><a href="artikel-pengurus.php"><button class="btn btn-outline-primary" type="button">Baca Selengkapnya</button></a></div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-4">

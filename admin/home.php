    ...
    <main class="page landing-page">
        <section class="clean-block clean-hero" style="background-image:url(&quot;../assets/img/wallpaper/kantor.jpg&quot;);color:rgb(0, 0, 0, 0.7)">
            <div class="text">
                ...
                <a href="../edit-artikel/artikel-fungsi.php#tujuan"><input class="btn btn-outline-light btn-lg" type="button" value="Selengkapnya"></a></div>
        </section>
        <section class="clean-block clean-services dark" id="artikel">
                <div class="container">
                    <div class="block-heading"><br><br>
                        ...
                        <a href="../edit-artikel/create.php"><button type="submit" class="btn-outline-primary btn-lg" name="buat-artikel">
                        Buat Artikel</button></a>
                    </div>
                    <div class="row">
            ...
            <div class="container">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6">
                        ...
                        1 kantong darah bisa selamatkan 3 nyawa.<br> Baca artikel: <a href="../edit-artikel/artikel-manfaat.php" class="text-danger"><i><strong>Manfaat Donor Darah</strong></i></a></p>
                        </div><a href="pendonor.php"><button class="btn btn-primary btn-lg" type="button">Daftar Sekarang</button></a></div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-5 feature-box"><i class="icon-star icon"></i>
                        <h4><a href="edit-artikel/artikel-karakteristik.php">Golongan Darah A</a></h4>
                        <p>Memiliki antigen A pada sel-sel darah merah, memiliki antibodi anti-B dalam plasma.</p>
                    </div>
                    <div class="col-md-5 feature-box"><i class="icon-star icon"></i>
                        <h4><a href="edit-artikel/artikel-karakteristik.php">Golongan Darah B</a></h4>
                        <p>Memiliki antigen B pada sel-sel darah merah, memiliki antibodi anti-A dalam plasma.</p>
                    </div>
                    <div class="col-md-5 feature-box"><i class="icon-star icon"></i>
                        <h4><a href="edit-artikel/artikel-karakteristik.php">Golongan Darah AB</a></h4>
                        <p>Memiliki antigen A dan B, tetapi tidak memiliki antibodi.</p>
                    </div>
                    <div class="col-md-5 feature-box"><i class="icon-star icon"></i>
                        <h4><a href="edit-artikel/artikel-karakteristik.php">Golongan Darah O</a></h4>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 col-md-3 item">
                        <h3>Pelayanan</h3>
                        <ul>
                            <li><a href="edit-stok.php">Stok Darah</a></li>
                            <li><a href="jadwal-donor.php">Jadwal Donor</a></li>
                            <li><a href="pendonor.php">Daftar Pendonor</a></li>
                            <li><a href="../user/hubungi-kami.php">Hubungi Kami</a></li>
                        </ul>
                    </div>
                    <div class="col-sm-6 col-md-3 item">
                        <h3>Tentang</h3>
                        <ul>
                            <li><a href="../edit-artikel/artikel-sejarah.php">Sejarah</a></li>
                            <li><a href="../edit-artikel/artikel-visimisi.php">Visi dan Misi</a></li>
                            <li><a href="../edit-artikel/artikel-tujuan.php">Tujuan Strategis</a></li>
                            <li><a href="../edit-artikel/artikel-struktur.php">Struktur Organisasi</a></li>
                        </ul>
                    </div>
